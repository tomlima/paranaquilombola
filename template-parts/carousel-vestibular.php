...
<div>
	<a href="https://novomackenzie.nznvaas.io/vestibular/">
		<h2 class="carousel__title carousel__title--vestibular">VESTIBULAR</h2>
	</a>
	<div class="swiper-container">
		...
		<div class="swiper-wrapper">
			...
			$the_query = new WP_Query(array(
				'category_name' => 'materias-vestibular',
				'post_status' => 'publish',
				'posts_per_page' => 6,
			));
			?>
					...
					<div class="swiper-slide" style="width: 18rem;">
						<div class="carousel__card">
							<a class="carousel__card--thumb" href="<?php echo get_permalink(get_the_ID()); ?>">
								...
								<?php endif; ?>
								<div class="carousel__card--category--left carousel__categoy--vestibular"><?php echo $categoryName; ?></div>
							</a>
