...
<div>
  <a href="https://blog.mackenzie.br/mundo-mackenzie/">
    <h2 class="carousel__title carousel__title--mundo-mackenzie">MUNDO MACKENZIE</h2>
  </a>
          ...
          <div class="swiper-slide" style="width: 18rem;">
            <div class="carousel__card">
              <a class="carousel__card--thumb" href="<?php echo get_permalink(get_the_ID()); ?>">
                ...
                <?php endif; ?>
                <div class="carousel__card--category--left carousel__category--mundo-mackenzie"><?php echo $categoryName; ?></div>
              </a>
